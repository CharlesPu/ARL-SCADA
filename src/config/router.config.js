...
export const asyncRouterMap = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        redirect: '/plant/list',
        component: RouteView,
        meta: { title: '植株管理', keepAlive: true, icon: bxAnaalyse },
        children: [
          {
            path: '/plant/area',
            name: 'PlantsArea',
            component: () => import('@/views/plant/Area'),
            meta: { title: '区域管理', keepAlive: false }
          },
          {
            path: '/plant/area-detail',
            name: 'PlantsAreaDetail',
            hidden: true,
            component: () => import('@/views/plant/AreaDetail'),
          ...
          },
          {
            ...
            meta: { title: '植株列表', keepAlive: false }
          },
          {
            path: '/plant/test',
            name: 'PlantsTest',
            component: () => import('@/views/plant/Test'),
